                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            ...
                            <h4><a href="single-product.php?pd=<?php echo $row['product_id']; ?>">  <?php echo $row['product_name']; ?></a></h2>
                            ...
                            <form action="addcart.php"  method="get" class="cart">
                                        <div class="quantity">
                                            ...
                                            <input type="number" size="4" class="input-text qty text" title="Qty" value="1" name="quantity" min="1" max="200" step="1">  
                                        </div>
