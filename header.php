        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="user-menu">
                        <ul>
                            <li><a href="#exampleModal" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><i class="fa fa-user"></i> تسجيل عميل جديد</a>
				   ...
				   <div class="form-group">
						 <label>تاكيد كلمة السر :</label>
                          ...
                          <li>
							<a href="#exampleModal2" data-toggle="modal" data-target="#exampleModal2" data-whatever="@mdo"><i class="fa fa-user"></i> دخول الأدمن </a>
						  ...
						  <li>
							<a href="#exampleModal3" data-toggle="modal" data-target="#exampleModal3" data-whatever="@mdo"><i class="fa fa-user"></i> تسجيل دخول العميل </a>
								...
								<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3">
								  <div class="modal-dialog" role="document">
									<div class="modal-content">
									  <div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
										<h4 class="modal-title" id="exampleModalLabel3"> تسجيل دخول </h4>
									  </div>
									<div class="modal-body">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h3 style="color:  #000;font: normal 36px 'Open Sans', cursive;margin: 0;"> Star<span style="color:  lightseagreen;">Technology</span></h3>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <div class="header-right">
                        ...
                        <li><a href="index_contactUs.php">تواصل معنا</a></li>
