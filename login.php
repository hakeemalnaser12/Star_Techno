...
<center>  <a href="#exampleModal3" data-toggle="modal" data-target="#exampleModal3" data-whatever="@mdo"><i class="fa fa-user" ></i>  تسجيل الدخول </a> </center> 
								  ...
								  <div class="modal-dialog" role="document">
									<div class="modal-content">
									  <div class="modal-header">
										...
										<h4 class="modal-title" id="exampleModalLabel3"> تسجيل دخول العميل</h4>
									  </div>
									<div class="modal-body">
									
									 <div class="card-body">
											<h5 class="card-title text-center">تسجيل دخول العميل</h5>
